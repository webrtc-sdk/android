...
SDK_BIN_URL=https://github.com/webrtc-sdk/android/releases/download/v${VERSION}/libwebrtc_prefixed_stripped.aar

echo "Downloading webrtc-sdk ${VERSION} prefixed stripped binary for android."
...
python3 tools/downgrade_class_version.py android-prefixed-stripped/shadow/libs/classes.jar
